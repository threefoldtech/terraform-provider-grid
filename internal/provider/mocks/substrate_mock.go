...
func (m *MockSubstrateExt) GetTwin(twinID uint32) (*substrate.Twin, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTwin", twinID)
...
func (mr *MockSubstrateExtMockRecorder) GetTwin(twinID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetTwin", reflect.TypeOf((*MockSubstrateExt)(nil).GetTwin), twinID)
}
