...
// KVStoreDelete mocks base method.
func (m *MockSubstrateExt) KVStoreDelete(identity subi.Identity, key string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "KVStoreDelete", identity, key)
	ret0, _ := ret[0].(error)
	return ret0
}

// KVStoreDelete indicates an expected call of KVStoreDelete.
func (mr *MockSubstrateExtMockRecorder) KVStoreDelete(identity, key interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "KVStoreDelete", reflect.TypeOf((*MockSubstrateExt)(nil).KVStoreDelete), identity, key)
}

// KVStoreGet mocks base method.
func (m *MockSubstrateExt) KVStoreGet(pk []byte, key string) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "KVStoreGet", pk, key)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// KVStoreGet indicates an expected call of KVStoreGet.
func (mr *MockSubstrateExtMockRecorder) KVStoreGet(pk, key interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "KVStoreGet", reflect.TypeOf((*MockSubstrateExt)(nil).KVStoreGet), pk, key)
}

// KVStoreSet mocks base method.
func (m *MockSubstrateExt) KVStoreSet(identity subi.Identity, key, value string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "KVStoreSet", identity, key, value)
	ret0, _ := ret[0].(error)
	return ret0
}

// KVStoreSet indicates an expected call of KVStoreSet.
func (mr *MockSubstrateExtMockRecorder) KVStoreSet(identity, key, value interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "KVStoreSet", reflect.TypeOf((*MockSubstrateExt)(nil).KVStoreSet), identity, key, value)
}
