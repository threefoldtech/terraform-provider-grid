...
require (
	...
	github.com/threefoldtech/tfgrid-sdk-go/grid-client v0.8.4
	github.com/threefoldtech/tfgrid-sdk-go/grid-proxy v0.8.4
	github.com/threefoldtech/tfgrid-sdk-go/rmb-sdk-go v0.8.4
