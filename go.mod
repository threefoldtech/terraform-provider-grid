...
require (
	...
	github.com/threefoldtech/tfgrid-sdk-go/grid-client v0.14.8
	github.com/threefoldtech/tfgrid-sdk-go/grid-proxy v0.14.8
	github.com/threefoldtech/tfgrid-sdk-go/rmb-sdk-go v0.14.8
